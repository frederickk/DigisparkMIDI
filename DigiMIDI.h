...
//-------------------------------------------------------------
//-------------------------- CLOCK DEFS ------------------------
static uint8_t CLKcnt; // Keep track of clock ticks.
static uint8_t CLKinterval = 24; // Default interval is quarter notes.
...
//
const PROGMEM char deviceDescrMIDI[19] = {
...
const PROGMEM char configDescrMIDI[] = {
...
public:
    ...
    void sendNoteOn(int key, int velocity = 100, uchar channel = 1)
    {
    ...
    void setClockTriggerInterval(uint8_t interval = 24)
    {
        CLKinterval = interval;
    }
};
...
extern "C"
{
    ...
    void usbFunctionWriteOut(uchar * data, uchar len)
    {
        ...
        // TODO (frederickk): Fix/test note-off interval checking.
        if (data[1] == 0x90) {
